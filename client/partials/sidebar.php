  ...
  <nav class="navbar bg-light navbar-light">
    ...
    <div class="navbar-nav w-100">
      ...
      <div class="nav-item dropdown">
        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i class="fa fa-pencil-alt me-2"></i>Registrar</a>
        <div class="dropdown-menu bg-transparent border-0">
          <a href="#" class="dropdown-item">Equipo político</a>
          <a href="#" class="dropdown-item">Jefe de UBCH</a>
          <a href="#" class="dropdown-item">Líder de calle</a>
        </div>
      </div>
      <a href="#" class="nav-item nav-link"><i class="fa fa-search me-2"></i>Consultar</a>
